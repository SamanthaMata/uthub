...
const UBICACIONES_CAMPUS = [
  { id: 'docencia', nombre: 'Docencia', tipo: 'Punto acad?mico', detalle: 'Edificio de docencia de la UTSC.', lat: 25.68957341733084, lng: -100.5123611969405 },
  { id: 'cafeteria', nombre: 'Cafeter?a UTSC', tipo: 'Comida y entregas', detalle: 'Punto principal para comprar comida o recoger pedidos.', lat: 25.689080321121647, lng: -100.51192132371544 },
  { id: 'cajas', nombre: 'Cajas de pago', tipo: 'Tr?mites y pagos', detalle: '?rea de cajas de pago dentro del plantel.', lat: 25.690762609496144, lng: -100.51130972310952 },
  ...
  { id: 'vinculacion', nombre: 'Edificio de Vinculaci?n', tipo: 'Servicios universitarios', detalle: 'Edificio de Vinculaci?n de la UTSC.', lat: 25.691149362259768, lng: -100.51214657905558 }
];
